...
namespace CameraView
{
    public partial class FrmAutoLocationParam : Form
    {
        ...
        private void FrmAutoLocationParam_Load(object sender, EventArgs e)
        {
            ...
            m_bDlgTypeModel = (bool)WriteRegistryKey.ReadParam("AUTO_LOCATION", "IDC_RADIO_STANDARD", false);
        ...
        private void btn_Ok_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                m_bDlgTypeModel = r_Standard.Checked;
                ...
                WriteRegistryKey.WriteParam("AUTO_LOCATION", "IDC_RADIO_STANDARD", m_bDlgTypeModel);
